  ...
  return {
    ...
    install(app: App) {
      ...
      app.config.globalProperties.$tc = (
        key: TranslationKey,
        count: number | Record<string, string | number | boolean>,
        defaultValue?: string,
      ) => {
      ...
      app.config.globalProperties.$td = (
        value: Date | number | string,
        options?: Intl.DateTimeFormatOptions,
      ) => {
        return i18n.td(value, options);
      };
      app.config.globalProperties.$tdr = (
        value: Date | number | string,
      ...
      app.config.globalProperties.$i18n = i18n as unknown;
