import { type PluralFunc, type TranslationKey } from "@i18n-micro/types";
...
export const I18nT = (props: I18nTProps): JSX.Element | null => {
  ...
  const createElement = (
    ...
    return h(elementTag, elementProps, children);
  };
  ...
  if (number !== undefined) {
    ...
    if (html) {
      return createElement(
        tag,
        { ...restProps, dangerouslySetInnerHTML: { __html: content } },
        undefined,
      );
    }
  ...
  if (relativeDate !== undefined) {
    ...
    const translation = t(
      keypath,
      { relativeDate: formattedRelativeDate, ...(params || {}) },
      undefined,
      route,
    );
    const content = typeof translation === "string" ? translation : String(translation);
  ...
  if (plural !== undefined) {
    ...
    if (html) {
      return createElement(
        tag,
        { ...restProps, dangerouslySetInnerHTML: { __html: translation } },
        undefined,
      );
    }
  ...
  if (hideIfEmpty && !content.trim()) {
    return defaultValue ? h(Fragment, null, defaultValue) : null;
  }
