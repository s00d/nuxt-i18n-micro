<template>
  <div class="async-component-with-i18n-route">
    ...
    <div class="route-info">
      <p>
        {{ $t("async-component-with-i18n-route::routeInfo.currentRoute") }}: {{ $getRouteName() }}
      </p>
...
$defineI18nRoute({
  locales: {
    en: {
      ...
      "async-component-with-i18n-route::description":
        "This component uses defineI18nRoute function",
    ...
    ru: {
      ...
      "async-component-with-i18n-route::description":
        "Этот компонент использует функцию defineI18nRoute",
    ...
    de: {
      ...
      "async-component-with-i18n-route::description":
        "Diese Komponente verwendet die defineI18nRoute-Funktion",
