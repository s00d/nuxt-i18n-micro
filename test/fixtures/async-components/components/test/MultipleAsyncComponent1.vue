<template>
  <div class="multiple-async-component-1">
    ...
    <div class="component-info">
      <p>
        <strong>{{ $t("multiple-async-component-1::componentId") }}:</strong> Multiple Async
        Component 1
      </p>
      <p>
        <strong>{{ $t("multiple-async-component-1::status") }}:</strong>
        {{ $t("multiple-async-component-1::loaded") }}
      </p>
    </div>
    <div class="actions">
...
const performAction = () => {
  actionResult.value = String(
    $t("multiple-async-component-1::actionResult") || "Action completed successfully",
  );
};
</script>
