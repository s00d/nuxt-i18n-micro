...
export const useI18nLocales = () => {
  ...
  if (!context) {
    throw new Error(
      "[i18n-micro] I18nLocalesContext not found. Make sure I18nLocalesContext is provided.",
    );
  }
  return context;
};
...
export const useI18nDefaultLocale = () => {
  ...
  if (!context) {
    throw new Error(
      "[i18n-micro] I18nDefaultLocaleContext not found. Make sure I18nDefaultLocaleContext is provided.",
    );
  }
  return context;
};
