...
export interface I18nStrategyInstance {
  ...
  localeRoute(
    targetLocale: string,
    routeOrPath: I18nStrategyResolvedRoute | string,
    currentRoute?: I18nStrategyResolvedRoute,
  ): I18nStrategyResolvedRoute | string;
  switchLocaleRoute(
    fromLocale: string,
    toLocale: string,
    route: I18nStrategyResolvedRoute,
    options?: { i18nRouteParams?: Record<string, Record<string, unknown>> },
  ): I18nStrategyResolvedRoute | string;
  ...
  getCurrentLocale(
    route: I18nStrategyResolvedRoute,
    getDefaultLocale?: () => string | null | undefined,
  ): string;
