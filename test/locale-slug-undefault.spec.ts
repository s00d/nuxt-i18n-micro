...
test.describe("locale-slug-undefault", () => {
  test("Test Locale Path", async ({ page, goto }) => {
    ...
    await expect(page.locator("#activity-skiing-locale")).toHaveAttribute(
      "href",
      "/en/activity/book-activity/skiing",
    );
    await expect(page.locator("#activity-hiking-locale")).toHaveAttribute(
      "href",
      "/en/activity/book-activity/hiking",
    );
    ...
    await expect(page.locator("#activity-locale-skiing")).toHaveAttribute(
      "href",
      "/en/change-activity/book-activity/skiing",
    );
    await expect(page.locator("#activity-locale-hiking")).toHaveAttribute(
      "href",
      "/en/change-activity/hiking",
    );
  ...
  test("Test Locale Path de", async ({ page, goto }) => {
    ...
    await expect(page.locator("#activity-skiing-locale")).toHaveAttribute(
      "href",
      "/de/activity/aktivitaet-buchen/ski-fahren",
    );
    await expect(page.locator("#activity-hiking-locale")).toHaveAttribute(
      "href",
      "/de/activity/aktivitaet-buchen/wandern",
    );
    ...
    await expect(page.locator("#activity-locale-skiing")).toHaveAttribute(
      "href",
      "/de/change-buchen/aktivitaet-buchen/ski-fahren",
    );
    await expect(page.locator("#activity-locale-hiking")).toHaveAttribute(
      "href",
      "/de/change-buchen/hiking",
    );
