...
test.describe("custom-regex", () => {
  ...
  test("test head", async ({ page, goto, baseURL }) => {
    ...
    await expect(page.locator("link#i18n-alternate-en-us")).toHaveAttribute(
      "href",
      `${normalizedBaseURL}`,
    );
    ...
    await expect(page.locator("link#i18n-alternate-de-de")).toHaveAttribute(
      "href",
      `${normalizedBaseURL}/de-de`,
    );
    await expect(page.locator("link#i18n-alternate-de_DE")).toHaveAttribute(
      "href",
      `${normalizedBaseURL}/de-de`,
    );
    await expect(page.locator("link#i18n-alternate-ru-ru")).toHaveAttribute(
      "href",
      `${normalizedBaseURL}/ru-ru`,
    );
