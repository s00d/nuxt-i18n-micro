---
url: 'https://s00d.github.io/nuxt-i18n-micro/guide/preset-local-testing.md'
description: >-
  Local production-preset checks for Vercel / Cloudflare / Netlify — Nitro-style
  runners + smoke-verify.
---
