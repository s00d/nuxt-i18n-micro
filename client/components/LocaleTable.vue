          ...
          <tr>
            ...
            >
              <div class="header-content">
                <span class="header-icon">{{ header.icon }}</span>
...
.locale-table-container {
  @apply border rounded-xl overflow-hidden shadow-sm bg-white;
}
...
.locale-iso {
  @apply text-slate-600 font-mono text-xs px-2 py-1 bg-slate-100 rounded;
}
