    ...
    <div id="test-results" class="test-results">
      ...
      <div class="result-item">
        ...
        <strong id="translations-loaded">{{
          translationsLoaded
            ? $t("async-components-test::results.yes")
            : $t("async-components-test::results.no")
        }}</strong>
      </div>
    </div>
...
$defineI18nRoute({
  locales: {
    en: {
      ...
      "async-components-test::test2.description":
        "Async component that should load its own translations",
    ...
    ru: {
      ...
      "async-components-test::description":
        "Тестирование асинхронных компонентов с переводами i18n",
      ...
      "async-components-test::test2.description":
        "Асинхронный компонент, который должен загружать свои переводы",
      "async-components-test::test3.title": "Тест 3: Асинхронный Компонент с defineI18nRoute",
      "async-components-test::test3.description":
        "Асинхронный компонент, использующий функцию defineI18nRoute",
      ...
      "async-components-test::test5.description":
        "Асинхронный компонент, который выбрасывает ошибку",
    ...
    de: {
      ...
      "async-components-test::test1.description":
        "Grundlegende Async-Komponente ohne Übersetzungen",
      "async-components-test::test2.title": "Test 2: Async-Komponente mit Übersetzungen",
      "async-components-test::test2.description":
        "Async-Komponente, die ihre eigenen Übersetzungen laden sollte",
