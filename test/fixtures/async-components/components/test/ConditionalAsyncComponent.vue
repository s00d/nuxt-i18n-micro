<template>
  <div class="conditional-async-component">
    ...
    <div class="component-info">
      <p>
        <strong>{{ $t("conditional-async-component::componentId") }}:</strong> Conditional Async
        Component
      </p>
      <p>
        <strong>{{ $t("conditional-async-component::status") }}:</strong>
        {{ $t("conditional-async-component::active") }}
      </p>
    </div>
  </div>
</template>
