...
import {
  ...
  extractLocalizedPaths as getLocalizedPathsMap,
} from "./core/localized-paths";
...
export class RouteGenerator {
  ...
  public resolveLocalizedPath(originalPath: string, localeCode: string): string {
    ...
    if (
      localeCode === this.defaultLocale.code &&
      !isCustom &&
      (this.strategy === "prefix_except_default" || this.strategy === "no_prefix")
    ) {
      shouldPrefix = false;
    }
