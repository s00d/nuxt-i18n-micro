...
_2026-02-13_ · [`f87fb97d`](https://github.com/s00d/nuxt-i18n-micro/commit/f87fb97d67963f867c5a844ddc3da84a76f44d63)

### Refactors

- update default current route from 'general' to 'index' ([`f87fb97`](https://github.com/s00d/nuxt-i18n-micro/commit/f87fb97d67963f867c5a844ddc3da84a76f44d63))
...
_2026-02-05_ · [`b97148f6`](https://github.com/s00d/nuxt-i18n-micro/commit/b97148f6abc409bdb02a74959cf98647ab2a0404)

### Fixes

- **router:** handle undefined first path segment in locale check ([`ac9b956`](https://github.com/s00d/nuxt-i18n-micro/commit/ac9b956fe6e0d841bbfcdb692783151f06838a4b))

### Refactors

- replace `TranslationCache` with `TranslationStorage` ([`b97148f`](https://github.com/s00d/nuxt-i18n-micro/commit/b97148f6abc409bdb02a74959cf98647ab2a0404))
...
_2025-12-26_ · [`b7d902ce`](https://github.com/s00d/nuxt-i18n-micro/commit/b7d902ce5d82e66f12225aab5d5bc28f3278f159)

### Features

- add initial package configuration for @i18n-micro/preact ([`b7d902c`](https://github.com/s00d/nuxt-i18n-micro/commit/b7d902ce5d82e66f12225aab5d5bc28f3278f159))
