...
export const I18nT = defineComponent({
  ...
  setup(props, { slots, attrs }) {
    ...
    if (!i18n) {
      throw new Error(
        "[i18n-micro] I18nT: i18n instance not found. Make sure i18n plugin is installed.",
      );
    }
    ...
    return () => {
      ...
      if (props.number !== undefined) {
        ...
        const translation = i18n.t(
          props.keypath,
          { number: formattedNumber, ...props.params },
          undefined,
          route,
        );
      ...
      if (props.date !== undefined) {
        ...
        const translation = i18n.t(
          props.keypath,
          { date: formattedDate, ...props.params },
          undefined,
          route,
        );
        return h(props.tag, { ...attrs, innerHTML: translation });
      ...
      if (props.relativeDate !== undefined) {
        ...
        const translation = i18n.t(
          props.keypath,
          { relativeDate: formattedRelativeDate, ...props.params },
          undefined,
          route,
        );
        return h(props.tag, { ...attrs, innerHTML: translation });
      ...
      // Regular translation
      const translation = (
        i18n.t(props.keypath, { ...props.params, ...options }, undefined, route) ?? ""
      ).toString();
