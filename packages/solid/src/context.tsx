...
import { I18nContext, I18nDefaultLocaleContext, I18nLocalesContext, I18nRouterContext } from './injection'
            ...
            {props.defaultLocale && (
              ...
              <I18nDefaultLocaleContext.Provider value={props.defaultLocale}>
                {props.routingStrategy && (
                  // @ts-expect-error - Provider components type conflict with Vue JSX
                  <I18nRouterContext.Provider value={props.routingStrategy}>{children}</I18nRouterContext.Provider>
                )}
