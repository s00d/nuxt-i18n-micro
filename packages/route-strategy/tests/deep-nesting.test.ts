  ...
  test("two deep branches from same root", () => {
            ...
            children: [
              {
                ...
                children: [
                  {
                    path: "reviews",
                    name: "shop-category-product-reviews",
                    file: "/pages/shop/category/product/reviews.vue",
                  },
                ],
              },
            ],
            ...
            children: [
              {
                ...
                children: [
                  {
                    path: "specs",
                    name: "shop-brand-item-specs",
                    file: "/pages/shop/brand/item/specs.vue",
                  },
                ],
              },
            ],
    ...
    const globalLocaleRoutes = {
      ...
      "/shop/category/product": {
        ...
        de: "/geschaeft/kategorie/produkt",
      },
