    ...
    <div id="test7" class="test-section">
      ...
      <div class="controls">
        ...
        >
          {{
            showConditional
              ? $t("async-components-test-2::test7.hideComponent")
              : $t("async-components-test-2::test7.showComponent")
          }}
        </button>
      </div>
    ...
    <div id="test-results" class="test-results">
      ...
      <div class="result-item">
        ...
        <strong id="translations-loaded">{{
          translationsLoaded
            ? $t("async-components-test-2::results.yes")
            : $t("async-components-test-2::results.no")
        }}</strong>
      </div>
    </div>
...
const DelayedAsyncComponent = defineAsyncComponent(
  () => import("../components/test/DelayedAsyncComponent.vue"),
);
const ConditionalAsyncComponent = defineAsyncComponent(
  () => import("../components/test/ConditionalAsyncComponent.vue"),
);
const MultipleAsyncComponent1 = defineAsyncComponent(
  () => import("../components/test/MultipleAsyncComponent1.vue"),
);
const MultipleAsyncComponent2 = defineAsyncComponent(
  () => import("../components/test/MultipleAsyncComponent2.vue"),
);
const MultipleAsyncComponent3 = defineAsyncComponent(
  () => import("../components/test/MultipleAsyncComponent3.vue"),
);
...
$defineI18nRoute({
  locales: {
    en: {
      ...
      "async-components-test-2::description":
        "Additional tests for async components with i18n translations",
      ...
      "async-components-test-2::test6.description":
        "Async component with artificial delay to test loading states",
      ...
      "async-components-test-2::test8.description":
        "Multiple async components loading simultaneously",
    ...
    ru: {
      ...
      "async-components-test-2::description":
        "Дополнительные тесты асинхронных компонентов с переводами i18n",
      ...
      "async-components-test-2::test6.description":
        "Асинхронный компонент с искусственной задержкой для тестирования состояний загрузки",
      "async-components-test-2::test7.title": "Тест 7: Условный Асинхронный Компонент",
      "async-components-test-2::test7.description":
        "Асинхронный компонент, который загружается условно",
      ...
      "async-components-test-2::test8.description":
        "Множественные асинхронные компоненты, загружающиеся одновременно",
    ...
    de: {
      ...
      "async-components-test-2::description":
        "Zusätzliche Tests für Async-Komponenten mit i18n-Übersetzungen",
      ...
      "async-components-test-2::test6.description":
        "Async-Komponente mit künstlicher Verzögerung zum Testen von Ladezuständen",
      ...
      "async-components-test-2::test8.description":
        "Mehrere Async-Komponenten, die gleichzeitig geladen werden",
