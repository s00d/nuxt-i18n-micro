...
- **release:** Patch bump (metadata only; no code changes vs 3.17.1).

## v3.17.1

[compare changes](https://github.com/s00d/nuxt-i18n-micro/compare/v3.17.0...v3.17.1)

### 🩹 Fixes

- **prerender:** Avoid double locale prefix when Nitro adds localized paths to the prerender list (`routeRules`, etc.) — no more `/fr/fr/...` spam ([#218](https://github.com/s00d/nuxt-i18n-micro/issues/218)).
- **module:** Remove stray merge-conflict markers left in the prerender hook (follow-up).

### 🎨 Styles

- **test:** Biome-format the issue #218 fixture and Vitest integration test.

### 🏠 Chore

- **release:** Undo mistaken `v4.0.0` bump / monster changelog; pin `release:lite` to `--patch` until tooling was fixed.
