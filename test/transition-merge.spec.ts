...
test.describe("Cumulative merge: translations survive page transition", () => {
  test("page A translations remain visible during leave animation when navigating to page B", async ({
    page,
    goto,
  }) => {
...
test.describe("Deep merge: overlapping nested keys survive page transition", () => {
   ...
   */
  test("overlapping nested key common.fromA survives when navigating A → B", async ({
    page,
    goto,
  }) => {
  ...
  test("overlapping nested key common.fromB survives when navigating B → A", async ({
    page,
    goto,
  }) => {
    // 1. Open page B
