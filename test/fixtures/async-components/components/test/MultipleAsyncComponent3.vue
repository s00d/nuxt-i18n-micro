<template>
  <div class="multiple-async-component-3">
    ...
    <div class="component-info">
      <p>
        <strong>{{ $t('multiple-async-component-3::componentId') }}:</strong> Multiple Async Component 3
      </p>
      <p>
        <strong>{{ $t('multiple-async-component-3::status') }}:</strong> {{ $t('multiple-async-component-3::loaded') }}
      </p>
    </div>
    <div class="actions">
