<template>
  <div>
    ...
    <div id="locale-links">
      <NuxtLink id="link-en" :to="$localeRoute({ name: 'locale-test' }, 'en')">
        Switch to English
      </NuxtLink>
      <NuxtLink id="link-de" :to="$localeRoute({ name: 'locale-test' }, 'de')">
        Switch to German
      </NuxtLink>
      <NuxtLink id="link-ru" :to="$localeRoute({ name: 'locale-test' }, 'ru')">
        Switch to Russian
      </NuxtLink>
    </div>
  </div>
