...
import type { PathStrategyContext, ResolvedRouteLike, RouteLike } from "./types";
...
export function resolvePathWithParams(path: string, params: Record<string, unknown> = {}): string {
  ...
  return path.replace(
    PARAM_PATTERN,
    (match, optKey?: string, reqKey?: string, catchAllKey?: string) => {
...
export function getRouteBaseName(
  route: RouteLike,
  options: GetRouteBaseNameOptions,
): string | null {
 ...
 */
export function getPathForUnlocalizedRoute(
  ctx: PathStrategyContext,
  route: ResolvedRouteLike,
  precomputed?: RouteAnalysis,
): string | null {
 ...
 */
export function getPathForUnlocalizedRouteByName(
  ctx: PathStrategyContext,
  routeName: string,
): string | null {
  const gr = ctx.globalLocaleRoutes;
 ...
 */
export function getAllowedLocalesForRoute(
  ctx: PathStrategyContext,
  route: ResolvedRouteLike,
  precomputed?: RouteAnalysis,
): string[] {
 ...
 */
export function getParentPathForNested(
  ctx: PathStrategyContext,
  nameSegments: string[],
  targetLocale: string,
): string {
 ...
 */
export function resolvePathForLocale(
  ctx: PathStrategyContext,
  path: string,
  targetLocale: string,
): string {
