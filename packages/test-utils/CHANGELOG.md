...
_2026-06-15_ · [`e27fd6ce`](https://github.com/s00d/nuxt-i18n-micro/commit/e27fd6cea9d9574a830694d41791ada055d60738)

### Fixes

- include publish-smoke in published files ([`e27fd6c`](https://github.com/s00d/nuxt-i18n-micro/commit/e27fd6cea9d9574a830694d41791ada055d60738))
- **hmr:** resolve TS6059 publish-smoke import outside rootDir ([`2d864ee`](https://github.com/s00d/nuxt-i18n-micro/commit/2d864ee7ef1cae7b8f302fb2cbd6cfeeba48d3b4))
...
_2026-02-13_ · [`5f0a66af`](https://github.com/s00d/nuxt-i18n-micro/commit/5f0a66af59221fd4c3156492e0745bbd682a6625)

### Features

- add routeName parameter to loadTranslations function ([`5f0a66a`](https://github.com/s00d/nuxt-i18n-micro/commit/5f0a66af59221fd4c3156492e0745bbd682a6625))
...
_2026-02-05_ · [`f4cd09e2`](https://github.com/s00d/nuxt-i18n-micro/commit/f4cd09e2014e685f3de0fe798e9082e3bc6f5840)

### Chore

- bump version to `1.1.0` in `package.json` ([`f4cd09e`](https://github.com/s00d/nuxt-i18n-micro/commit/f4cd09e2014e685f3de0fe798e9082e3bc6f5840))
...
_2025-12-26_ · [`f43d4152`](https://github.com/s00d/nuxt-i18n-micro/commit/f43d4152052a0ac46c887f658abdf0c45fd4de05)

### Chore

- update version and dependencies in package.json ([`f43d415`](https://github.com/s00d/nuxt-i18n-micro/commit/f43d4152052a0ac46c887f658abdf0c45fd4de05))
...
- add overwrite option to mergeTranslations function ([`ff54ad0`](https://github.com/s00d/nuxt-i18n-micro/commit/ff54ad017527b69a4d0bf6f0217f11719395867e))

### Refactors

- update comments to English for clarity ([`3189c30`](https://github.com/s00d/nuxt-i18n-micro/commit/3189c306c18967bdd820818d5a50936447c5d9a0))

### Tests

- **tests:** update comment for clarity on locale dependency ([`19192a4`](https://github.com/s00d/nuxt-i18n-micro/commit/19192a4065c20ce4f3d41152ed682c916d361c34))
...
- rename package and update imports to @i18n-micro ([`703432d`](https://github.com/s00d/nuxt-i18n-micro/commit/703432d83ea5026d5a8f6cfeb2a0d95fe5c557a0))
...
- suppress TypeScript error in nuxt.config.ts ([`24fc45d`](https://github.com/s00d/nuxt-i18n-micro/commit/24fc45d8f350bb8d38a2c095802fd318a447d260))

### Refactors

- update import path for translation types ([`f2ed77a`](https://github.com/s00d/nuxt-i18n-micro/commit/f2ed77aff13337262782bb11ae67df605d8ecf3a))
...
- clear ([`2d367b1`](https://github.com/s00d/nuxt-i18n-micro/commit/2d367b1a168aa14feebf234686bbcfb3e038fe05))

## 1.0.5

_2025-01-16_ · [`991dbc20`](https://github.com/s00d/nuxt-i18n-micro/commit/991dbc2021789042d66e6fdf05cd11fc27096fec)

### Features

- improve locale handling in translation utilities ([`991dbc2`](https://github.com/s00d/nuxt-i18n-micro/commit/991dbc2021789042d66e6fdf05cd11fc27096fec))

## 1.0.4

_2025-01-09_ · [`9c64863f`](https://github.com/s00d/nuxt-i18n-micro/commit/9c64863f149e635467276ac1019a2eecc3737551)

### Refactors

- simplify locale handling by using i18nHelper ([`0fb3220`](https://github.com/s00d/nuxt-i18n-micro/commit/0fb3220830f8e94dc8c10507e5e847257b5bb9ac))
...
- bump version to 1.0.4 in `package.json` ([`9c64863`](https://github.com/s00d/nuxt-i18n-micro/commit/9c64863f149e635467276ac1019a2eecc3737551))
...
- add utility functions for i18n testing ([`265bd98`](https://github.com/s00d/nuxt-i18n-micro/commit/265bd98f3e1c88da26339e8961b644239aa9499e))
