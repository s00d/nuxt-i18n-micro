...
export const Components: React.FC = () => {
  ...
  const { t, tn, td, tdr, getLocales, locale, getLocaleName, switchLocale, localeRoute } = useI18n({
  ...
  return (
    <div>
      ...
      >
        ...
        <p>
          <I18nT keypath="greeting" params={{ name: "Preact" }} />
        </p>
        <p>
      ...
      >
        ...
        <div style={{ display: "flex", gap: "15px", flexWrap: "wrap" }}>
          <I18nLink
            ...
            activeStyle={{ fontWeight: "bold", color: "#42b983" }}
          >
            {t("nav.home")}
          </I18nLink>
          <I18nLink
