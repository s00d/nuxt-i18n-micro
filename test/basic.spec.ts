...
test.describe('basic', () => {
  ...
  test('test locale switching on locale-test page', async ({ page }) => {
    ...
    await expect(page.locator('#date-tdr')).toHaveText('2 years ago')
    ...
    await expect(page.locator('#date-tdr-component')).toHaveText('The relative date is: 2 years ago')
    ...
    await expect(page.locator('#date-tdr')).toHaveText('vor 2 Jahren')
    ...
    await expect(page.locator('#date-tdr-component')).toHaveText('Das relative Datum ist: vor 2 Jahren')
    ...
    await expect(page.locator('#number-tn')).toHaveText('1 234 567,89')
    await expect(page.locator('#date-td')).toHaveText('31.12.2023')
    await expect(page.locator('#date-tdr')).toHaveText('2 года назад')
    ...
    await expect(page.locator('#date-tdr-component')).toHaveText('Относительная дата: 2 года назад')
