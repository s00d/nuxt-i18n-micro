...
async function main() {
  ...
  console.log(
    `   Relative time (2 days ago): ${i18n.tdr(now.getTime() - 2 * 24 * 60 * 60 * 1000)}\n`,
  );
  ...
  console.log(
    `   Page-specific 'title' (home route): ${i18n.t("title", undefined, undefined, "home")}`,
  );
  console.log(
    `   Page-specific 'description' (home route): ${i18n.t("description", undefined, undefined, "home")}`,
  );
  console.log(
    `   Page-specific 'hero.title' (home route): ${i18n.t("hero.title", undefined, undefined, "home")}\n`,
  );
  ...
  console.log(
    `   Route-specific (custom-route): ${i18n.t("title", undefined, undefined, "custom-route")}\n`,
  );
  ...
  console.log(
    `   Page-specific 'title' (about route): ${i18n.t("title", undefined, undefined, "about")}`,
  );
  console.log(
    `   Page-specific 'content.heading' (about route): ${i18n.t("content.heading", undefined, undefined, "about")}`,
  );

  // Demonstrate with different locales
  i18n.locale = "fr";
  console.log(
    `   French page-specific 'title' (about route): ${i18n.t("title", undefined, undefined, "about")}`,
  );
  i18n.locale = "de";
  console.log(
    `   German page-specific 'title' (about route): ${i18n.t("title", undefined, undefined, "about")}`,
  );
  i18n.locale = "en";
  console.log();
  ...
  console.log(
    `   Missing key with default: ${i18n.t("nonexistent.key", undefined, "Default value")}\n`,
  );
