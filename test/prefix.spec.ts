...
test.describe("prefix strategy", () => {
  test("navigate to test-page, check URL and text, switch language and verify text and URL changes", async ({
    page,
    goto,
  }) => {
    // Go to the main page
  ...
  test("redirect from / to /<locale>/ with cookie set - no error flash", async ({
    page,
    goto,
    baseURL,
  }) => {
