<template>
  <div>
    <div v-if="node.isFile" :class="['file-item', { selected: isSelected }]" :style="indentStyle" @click="handleFileClick">
      <span class="file-icon">
        <svg class="icon" viewBox="0 0 24 24">
          ...
          <g transform="translate(4 4) scale(0.8)">
            ...
            />
            <!-- Parallels -->
            <path d="M2 12h20M5 5.2l14 14M5 18.8l14-14" fill="none" stroke="currentColor" stroke-width="1" />
          </g>
        </svg>
      </span>
    ...
    <div v-else>
      <div :class="['folder-header', { expanded: isExpanded, selected: selected }]" :style="indentStyle" @click="toggleExpand">
        <span class="chevron">
          <svg class="icon" viewBox="0 0 24 24">
            <path v-if="isExpanded" d="M19 9l-7 7-7-7" fill="none" stroke="currentColor" stroke-width="2" />
